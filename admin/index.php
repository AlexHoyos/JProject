...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;height:100vh">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="#" class="nav-link <?=($actual=="index")?"active":""?>" aria-current="page">
      ...
      <li>
        <a href="#" class="nav-link text-white <?=($actual=="pinturas")?"active":""?>">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>
          Pinturas
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white <?=($actual=="mensajes")?"active":""?>">
          <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>
            Mensajes
          <?php
